...
void CubeBoard::init() {
  ...
  glBufferData(GL_ARRAY_BUFFER, blocksPositions.size() * sizeof(glm::vec3),
               &blocksPositions[0], GL_STATIC_DRAW);
