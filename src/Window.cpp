...
void Window::makeContextCurrentFrame() { glfwMakeContextCurrent(window); }
...
inline GLFWwindow *Window::getWindow() const { return this->window; }

inline int Window::getWidth() const { return _width; }

inline int Window::getHeight() const { return _height; }

bool Window::getFocused() const { return _focused; }
